...
- execution plan
- strategy decision
- stack order when `auto-stack-pr` is requested
...
- order stacked PR slices from trunk-nearest foundation work to dependent work
...
- stacked PR order cannot be determined safely
